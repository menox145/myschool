        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-4 py-8 text-center text-gray-500">Belum ada data kelas</td>
                        </tr>
                    @endforelse
                    ...
                    <form id="formKelas" action="{{ route('kelas.store') }}" method="post">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="jumlah_siswa" id="jumlah_siswa"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-yellow-500 @error('jumlah_siswa') border-red-500 @enderror"
                                placeholder="0" min="0" value="{{ old('jumlah_siswa') }}" required>
                            @error('jumlah_siswa')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
