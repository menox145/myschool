...
<head>
    <meta charset="UTF-8">
    <title>Rapot Tahfidz - {{ $kelas->nama_kelas }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="no-print" style="padding: 10px; background: #f0f0f0; text-align: center;">
        <button onclick="window.print()" style="padding: 8px 20px;">Print Semua - {{ $kelas->nama_kelas }} -
            {{ count($dataRapot) }} Siswa</button>
    </div>
    ...
    @foreach ($dataRapot as $data)
        ...
        <div class="page">
            {{-- HEADER --}}
            @include('layouts.kop-rapot', ['siswa' => $siswa, 'tahun' => $tahun, 'jenis' => 'TAHFIDZ'])
            ...
            <table class="nilai">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td colspan="4" class="text-center"><b>{{ $data['total_nilai'] ?? 0 }}</b></td>
                    </tr>
                    <tr>
                        <td colspan="2" class="text-center"><b>Rata-rata</b></td>
                        <td colspan="4" class="text-center"><b>{{ $rata_rata }}</b></td>
                    </tr>
                </tbody>
            </table>
